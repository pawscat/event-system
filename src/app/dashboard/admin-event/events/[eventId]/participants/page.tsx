    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex gap-2">
          ...
          <Link href={`/dashboard/admin-event/events/${eventId}/participants/import`} className="px-4 py-2 border border-border-light bg-surface-container-lowest text-text-main font-label-md text-[14px] font-semibold rounded-lg hover:bg-surface-container-low transition-colors flex items-center gap-2">
            <span className="material-symbols-outlined text-sm">upload_file</span>
            Import
          </Link>
          <Link href={`/dashboard/admin-event/events/${eventId}/participants/new`} className="px-4 py-2 bg-secondary text-on-secondary font-label-md text-[14px] font-semibold rounded-lg hover:bg-secondary/90 transition-colors shadow-sm flex items-center gap-2">
